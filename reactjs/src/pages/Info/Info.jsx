    ...
    return (
        <div className='container-info pd-80'>
            <div className="des d-flex justify-content-start ">
                ...
                <p className='m-0 mr-2 pt-2 pb-2 color'>{film.theloai.join(", ")}</p>
                <i className="fa fa-angle-right mr-2 pt-2 pb-2 color" />
                <p className='m-0 mr-2 pt-2 pb-2'>{film.name}</p>
            </div>
            <div className="film-info">
                <div className="banner" style={{ backgroundImage: `url(${film.src})` }}>
                    <img className='avatar' src={`${film.src}`} alt="" />
                </div>
                <div className="text">
                    <h1>{film.name}</h1>
