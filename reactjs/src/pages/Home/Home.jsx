...
import { getPhimLe, getPhimLeMoiCapNhat, getPhimLeTheoTheLoai, getPhimChieuRap, getPhimChieuRapTheoNam } from '../../redux/reducer/filmReducer';
...
export default function Home(props) {
    ...
    useEffect(() => {
        const actionGetPhimLe = getPhimLe()
